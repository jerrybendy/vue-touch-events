...
function touchMoveEvent(event) {
    ...
    if (!$this.touchMoved) {
        var tapTolerance = _options.tapTolerance
        ...
        var swipeOutBounded = _options.swipeTolerance
...
function touchEndEvent(event) {
    ...
    if (!$this.touchMoved) {
        ...
        if ($this.callbacks.longtap && event.timeStamp - $this.touchStartTime > _options.longTapTimeInterval) {
        ...
        var swipeOutBounded = _options.swipeTolerance, direction
...
function addTouchClass($el) {
    var className = $el.$$touchClass || _options.touchClass
...
function install(Vue, options) {
    ...
    Vue.directive('touch-class', touchClassDirective)
}
...
if (typeof module === 'object') {
    ...
    exports.touchClassDirective = touchClassDirective
